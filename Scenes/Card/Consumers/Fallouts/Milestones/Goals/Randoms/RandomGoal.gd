...
const MEMBER_TITLE_TEXT = 'New Member'
const CAUSE_TITLE_TEXT = 'Found Cause'
const EVENT_TITLE_TEXT = 'Social Action'
const OPPORTUNITY_DESCRIPTION_TEXT = 'Seize opportunities to reach this goal.'
const THREAT_DESCRIPTION_TEXT = 'Neutralize threats to reach this goal.'
const STRENGTH_DESCRIPTION_TEXT = 'Realize strengths to reach this goal.'
const WEAKNESS_DESCRIPTION_TEXT = 'Address weaknesses to reach this goal.'
